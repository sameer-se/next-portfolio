    ...
    >
      <div className="lg:w-3/5 flex flex-col gap-10 lg:gap-16">
        ...
        >
          ...
          <h1 className="font-bold text-5xl text-center py-2 text-teal-400 lg:text-start lg:text-7xl bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-blue-500">
            Sameer Khadka
          </h1>
        </motion.div>
